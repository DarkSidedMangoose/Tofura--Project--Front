    ...
    <div className="w-100% h-16 flex justify-center items-center ">
      <div className="flex w-98% justify-between">
        <div className="w-100% h-16 flex items-center mt-2 gap-2 ">
          ...
          ></input>
          <div className="h-8 w-8 border-gray-800 bg-white rounded border-2 cursor-pointer flex justify-center items-center shadow-lg shadow-black hover:opacity-55 ">
            <img src={Search} className="h-4"></img>
          </div>
          <div className="h-8 w-8 border-gray-800 bg-white  rounded border-2 flex justify-center items-center cursor-pointer shadow-lg shadow-black hover:opacity-55">
        ...
        <div className=" h-16 flex items-center mt-2 gap-2 ">
          ...
          <div className="h-8 w-40  border-gray-800 bg-white  rounded border-2 flex justify-evenly items-center cursor-pointer shadow-lg shadow-black hover:opacity-55">
